...
function Body(){
    ...
    <Container>
        ...
        <Image src= "/img/Faye_Wong_03.jpg" width = "650" height="420" alt = "王菲"></Image>
        <ConText>
            王菲對中國樂壇有無與倫比的貢獻，她至今發出過大大小小20多張華語專輯，唱過的華語歌曲更是數以百計。她曾在中國內地，臺灣，香港等地區開過演唱會，她現時已經擁有過百萬的粉絲數量。
        </ConText>
        <ConText>
        作為知名歌手演員，王菲曾包攬大中華地區兩岸三地包括叱咤樂壇流行榜頒獎典禮、十大中文金曲頒獎音樂會、勁歌金曲頒獎典禮、新城勁爆頒獎禮、四台聯頒音樂大獎、台灣金曲獎、全球華語榜中榜、音樂風雲榜、新加坡金曲獎、全球華語歌曲排行榜、CASH金帆音樂獎、華語音樂傳媒大獎、CCTV-MTV音樂盛典等各地區權威頒獎典禮「最佳女歌手」獎項，也獲得過如健力士世界紀錄銷量最高粵語女歌手、健力士世界紀錄銷量最高的遊戲主題曲、福布斯中國名人榜最吸金女藝人、二十世紀十大文化偶像、中國慈善名人榜榜首、 新中國六十年最有影響力文化人物第二名等榮譽。她也曾獲瑞典斯德哥爾摩電影節銅馬獎和香港電影評論學會影后，並多次被提名香港電影金像獎、台灣電影金馬獎影后。
        </ConText>
        <Image src = "/img/1200px-Faye_Wong_03.jpg" width = "600" height = "1000"alt = "王菲"></Image>
        <ConText>
        ...
        <Image src = "/img/faye_Wong_with_a_man.jpg" width = "720" height = "450" alt = "王菲和謝霆鋒一起"></Image>
    </Container>
    )
}

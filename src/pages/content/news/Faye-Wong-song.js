...
function Body(){
    return (
        <Container>
            ...
            <Image src={"/img/Faye_Wong_04.jpg"} width = "600" height = "300"alt = "王菲"></Image>
            <ConText>
            ...
            <Image src={"/img/因為愛情.jpg"} alt = "因為愛情" width = "400" height = "400"></Image>
            <ConText>
            ...
            <Image src="/img/光之翅.jpg" width = "300" height ="300" alt = "光之翅 王菲"></Image>
            <ConText>
            ...
            <Image src= "/img/謝霆鋒和王菲.jpg" width = "300" height="350" alt ="謝霆鋒和王菲"></Image>
        </Container>
    )
}

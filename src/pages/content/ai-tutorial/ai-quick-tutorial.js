...
function Page(){
    return(
        <Container>
            <ConTitle id="1-title" size={"h1"} order={1}>什麼是AI? 10分鐘內學懂AI</ConTitle>
            <ConTitle id="2-title" size={"h2"} order={2}>定義AI</ConTitle>
            ...
            <ConTitle id="3-title" size={"h2"}  order={2}>AI類型</ConTitle>
            ...
            <ConTitle size={"h2"}  order={3}>Machine Learning(ML)  機器學習</ConTitle>
            ...
            <ConTitle size={"h2"}  order={3}>Deep learning (DL)深度學習</ConTitle>
            ...
            <ConTitle size={"h2"}  order={2}>AI 的重要性?</ConTitle>
            <ConText>AI能幫助企業成長、找到新的收入管道，並解決企業遇到的難題
                機器學習實現了自動化和優化一些傳統工作，例如顧客回饋、財報...等
                亦能夠自動高速</ConText>
            <ConTitle size={"h2"}  order={2}>AI如何運作？</ConTitle>
            <ConTitle size={"h2"}  order={3}>機器學習</ConTitle>

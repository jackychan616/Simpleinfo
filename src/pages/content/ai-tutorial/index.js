...
const Bloglist=[
    ...
    {"name":"什麼是AI?","path":"ai-tutorial/ai-quick-tutorial","img":"/img/ai.jpg","date":"12/3/2023"},
    {"name":"淺談AI","path":"ai-tutorial/ai-light-talk","img":"/img/ai-light-talk/ai-2.jpg","date":'13/3/2023'}
];
...
export default function content(){
    return (
        <>
            <Container>
                <Page hTitle="AI 教學" img="/img/ai.webp"
                 fill

...
export default function Page(){
    return(
        ...
        <Container>
            ...
            <Image src="https://github.com/deep-floyd/IF/blob/develop/pics/nabla.jpg" alt="DeepFloyd" caption="DeepFloyd IF生成的圖片"/>
            ...
            <Image src="/img/deepfloydif/photo2.png" alt="DeepFloyd IF 文字生成"/>
            <Space h="lg"/>
            <Image src="/img/deepfloydif/photo3.png" alt="DeepFloyd IF 文字生成"/>
            <ConTitle order={2} size="h2">圖片生成範例</ConTitle>
            <Image src="/img/deepfloyd/photo4.png" alt="DeepFloyd IF 圖片生成範例" caption="提示詞: a photo of a full size old rusty sign that says 'Deep Floyd Stree', photo realism, bokeh, 50mm cine lens, super sharp focus.'" />
            <Image src="/img/deepfloyd/photo5.png" alt="DeepFloyd IF 圖片生成範例"caption="提示詞: 4 bottles of wine next to each other labeled (1,2,3,4)" />

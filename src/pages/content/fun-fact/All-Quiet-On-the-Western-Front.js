...
function Conpage(){
    return(
        <Container>
            ...
            <ConText>
            《西線無戰事》是一部德國反戰電影，改編自埃里希·瑪利亞·雷馬克的同名小說。該片由路易斯·邁爾斯執導，於 1979 年上映，獲得了眾多的好評與獎項，被譽為是史上最偉大的反戰電影之一。更奪得2023奧斯卡最佳國際電影、攝影、布景設計及配樂合共4個獎項 , 擊敗多個對手
            </ConText>
            <ConText>
            ...
            <Image src="/img/西線無戰事_03.webp" height = "300" width="120" caption = "保羅和朋友偷鵝" alt = "西線無戰事"/>
            <ConText>
            除此之外，該片在技術製作方面也很出色。攝影師所拍攝的場景呈現出真實的感覺，並且音效將戰爭場景的氣氛展現得淋漓盡致。電影的配樂也非常精彩，強調了戰爭的緊張和悲傷。

            </ConText>
            <Space h = "lg"/>
            <Image src="/img/西線無戰事_04.jpg" height = "300" width = "110" caption = "戰場上的軍官" alt = "西線無戰事"/>
            <ConText>
...
export default function page(){
    return(
        <>
            ...
            <Meta pageTitle="西線無戰事 - 為何奪得奧斯卡最佳國際影片獎" description="《西線無戰事》是一部德國反戰電影，改編自埃里希·瑪利亞·雷馬克的同名小說。該片由路易斯·邁爾斯執導，於 1979 年上映，獲得了眾多的好評與獎項，被譽為是史上最偉大的反戰電影之一。更奪得2023奧斯卡最佳國際電影、攝影、布景設計及配樂合共4個獎項 , 擊敗多個對手" keywords="西線無戰事2023奧斯卡最佳國際電影、攝影、布景設計及配樂合共4個獎項,西線無戰事,德國反戰電影,2023奧斯卡,最佳國際電影,第一次世界大戰" img = "/img/西線無戰事_01.jpeg"/>
            </Head>
            <Conpage/>
        </>
    );

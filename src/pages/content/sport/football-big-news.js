 ...
 function CPage(){
    return(
        <Container>
            ...
            <Image src="/img/football-big-news/2.webp" maw={600} alt="畢士比上任為主帥"/>
            ...
            <Image src="/img/football-big-news/5.5.jpg" maw={500} alt="曼聯史上第一座歐聯獎盃"/>
            <ConTitle order={2}>第二階段：費格遜皇朝（1986年至2013年）</ConTitle>
            <Image src="/img/football-big-news/5.webp" maw={600} caption="畢士比" alt=""/>
            <Space h="lg"/>
            ...
            <Image src="/img/football-big-news/7.jpg" maw={500} alt="成績不如人意曼聯"/>
            <ConText>2013年，莫耶斯上任。他帶領的曼聯成績不如人意，聯賽排名一直在前五名之外，更在足總盃第三圈出局。又宣佈無緣下屆歐聯，同時終止球隊連續十八年參加歐聯的紀錄。最後曼聯在這球季只取得聯賽第七名，並失去下季歐霸盃的參賽資格。4月22日，曼聯宣佈解僱莫耶斯，結束其不足10個月的任期，並由傑斯兼任暫代領隊。這個賽季季也是曼聯英超以來最黑暗的賽季。</ConText>
            ...
            <Image src="/img/football-big-news/8.jpg" caption="1998勝利"maw={400} alt="1998"/>
            <Space h="lg"/>
            <Image src="/img/football-big-news/9.avif" caption ="舒米高"maw={100} alt="舒米高"/>
            <Space h="lg"/>
            <Image src="/img/football-big-news/10.jpg"  caption="朗尼" maw={250} alt="朗尼"/>
            <Space h="lg"/>
            <Image src="/img/football-big-news/11.jpg" caption="C朗" maw={400} alt="C朗"/>
            <Space h="lg"/>
            <Image src="/img/football-big-news/12.jpg" caption="迪基亞" maw={300 } alt="迪基亞"/>
            <Space h="lg"/>
            <Image src="/img/football-big-news/13.jpg"caption="雲佩斯" maw={400} alt="雲佩斯"/>
            <Space h="lg"/>
        </Container>
    );
}

...
import Meta from '../../components/meta';
 function CPage(){
    return(
        <Container>
            <Image src="/img/football-big-news/1.webp" alt=" 曼聯"/>
            ...
            <Image src="/img/football-big-news/2.webp" alt="畢士比上任為主帥"/>
            ...
            <Image src="/img/football-big-news/4.webp" alt=""/>
            <ConText>球隊在67至68年球季歐聯決賽中大勝賓菲加，奪得曼聯史上第一座歐聯獎盃。</ConText>
            <Image src="/img/football-big-news/5.5.webp" alt="曼聯史上第一座歐聯獎盃"/>
            <ConTitle order={2}>第二階段：費格遜皇朝（1986年至2013年）</ConTitle>
            <Image src="/img/football-big-news/5.webp" alt=""/>
            <ConText>在畢士比退下主帥一職後，球隊再次陷入一段低谷期。十多年內連續更換過5位領隊，但是都沒有獲得聯賽冠軍。</ConText>
            <ConText> 1986年11月曼聯傳奇教頭費格遜上任。1987年費格遜拜訪並簽下賴恩·傑斯。在1992/93年球季曼聯結束了獎杯乾早期，奪得英超冠軍。在1991賽季中簽下了許多名將，例如：丹麥門將彼得·舒米高、「大帝」艾力·簡東拿等。(photo: </ConText>
            <Timeline active={5} lineWidth={3} bulletSize={16}>
                <Timeline.Item>
            ...
            <Image src="/img/football-big-news/7.jpg" alt="成績不如人意曼聯"/>
            <ConText>2013年，莫耶斯上任。他帶領的曼聯成績不如人意，聯賽排名一直在前五名之外，更在足總盃第三圈出局。又宣佈無緣下屆歐聯，同時終止球隊連續十八年參加歐聯的紀錄。最後曼聯在這球季只取得聯賽第七名，並失去下季歐霸盃的參賽資格。4月22日，曼聯宣佈解僱莫耶斯，結束其不足10個月的任期，並由傑斯兼任暫代領隊。這個賽季季也是曼聯英超以來最黑暗的賽季。</ConText>
            ...
            <Image src="/img/football-big-news/8.jpg" alt="1998"/>
            <ConText>2003 勝利</ConText>
            <Image src="/img/football-big-news/9.avif" alt="2003"/>
            <ConText>舒米高</ConText>
            <Image src="/img/football-big-news/10.jpg" alt="舒米高"/>
            <ConText>朗尼</ConText>
            <Image src="/img/football-big-news/11.jpg" alt="朗尼"/>
            <ConText>迪基亞</ConText>
            <Image src="/img/football-big-news/11.jpg" alt="迪基亞"/>
            <ConText>雲佩斯</ConText>
            <Image src="/img/football-big-news/12.jpg" alt="雲佩斯"/>
        </Container>
    );
}

...
function Body() {
  return (
    <Container>
      ...
      <Space h={'sm'} />
      <ConText>
       遊戲發生在漂浮於天空中的神秘古跡，玩家需要前往隨機生成的遺跡迷宮，挑戰種類繁多的敵人與巨大的怪物首領，收集各式各樣的「魂靈」，並使用獲得的「瑪娜」來修復受損的方舟。在这里，鍊金術師将被授予不同才能，导引元素之力。你将扮演一位名为「諾婭」的神秘鍊金術師，在探索中邂逅性格各异、能力独特的魂靈们，和他们一起击败强敌，找回失散的朋友——同时，逐步发掘「遺蹟」的真相。
      </ConText>
      <Space h={'lg'} />

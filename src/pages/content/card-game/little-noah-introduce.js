...
function Body(){
    return(
        <Container>
            ...
            <Space h={"lg"}/>
            <ConText>《小小諾亞-樂園的繼承者》已經于 2022 年 6 月 28 日在PS4/Switch/Steam 平台上架，普通版本為HKD$76元，而特別版本則是HKD$104元。《小小諾婭 樂園繼承者》作為一款定價較便宜的輕量級Roguelike單機遊戲，還是值得一玩的。畫風清新可愛、音樂悅耳動聽、也有一定的戰術性，對於曾經被隨機性玩法的「勸退」過的新手玩家們來說，是個入坑的好選擇，如果能通過後續的 DLC 一點點把遊戲內容填充上去的話，想必可以獲得更好的評價吧。</ConText>
        </Container>

    ...
    <>
      ...
      <div className="page_container">
        ...
        <div className="container ">
          ...
          <div className="container">
            <p>
              擁有最高點數的玩家獲勝,其點數必須等於或低於21點,2點至10點的牌以牌面的點數計算,J、Q、K
              每張為10點。A可記為1點或11點,
            </p>
            <p>
              若玩家會因A而爆二十一點則A可算為1點。通常每次以四至六副撲克牌遊玩,直至玩剩一副或一半為止,再重新洗牌
            </p>
          </div>
        </div>
        ...
        <div className="container ">
          ...
          <p>
            如果閒家手中的一張暗牌和一張明牌等於21點,這副牌叫做二十一莊家須向該閒家賠上1.5倍（或1.2倍）注碼。
          </p>
        </div>
        ...
        <div className="container v">
          <h4>五龍（過五關）</h4>
          <p>
            如果要牌直至手上有5張牌而又沒有爆21點,對面如果為21點 則平手
            反之則陪對方3倍
          </p>
        </div>
        ...
        <div className="container">
          <h4>平手</h4>
          <p>
            若莊家和眾閒家要以點數決勝,若該閒家和莊家手上所擁有的牌的總點數一樣或Black
            Jack的話,算平手,閒家可拿回原賭注。
          </p>
        </div>
...
export default function page() {
  return (
    <>
      <Meta
        description="本章是二十一點教學,二十一點是經典的啤牌遊戲"
        keywords={
          '啤牌,樸克牌,21點,二十一點,桌遊,教學,親子,聯誼,香港,臺灣,大學'
        }
      />
      <Page />
    </>

                    ...
                    <Card key={item.id} withBorder radius="md">
                      <Stack spacing={6}>
                        ...
                        <Group spacing="xs">
                          ...
                          {item.status === 'approved' ? <Button size="xs" component={Link} href={`/community/${item.slug || item.id}`} variant="outline">Public</Button> : null}
                        </Group>
                      </Stack>
                    </Card>
                  ))}
                          ...
                          <td>
                            <Group spacing="xs">
                              ...
                              {item.status === 'approved' ? (
                                <Button size="xs" component={Link} href={`/community/${item.slug || item.id}`} variant="outline">
                                  Public
                                </Button>
                              ) : null}
                            </Group>
